    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-200">
      ...
      <section className="py-12 bg-green-50 dark:bg-gray-800">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="bg-white dark:bg-gray-700 rounded-2xl shadow-lg p-8 border border-green-200 dark:border-gray-600">
            <h2 className="text-2xl font-bold text-center text-gray-800 dark:text-white mb-6">
              🛡️ Your Daily Security Checklist
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="flex items-center gap-3 bg-green-50 dark:bg-green-900/30 rounded-lg p-4">
                <CheckCircle className="w-6 h-6 text-green-600 dark:text-green-400 flex-shrink-0" />
                <span className="text-gray-700 dark:text-gray-200 font-medium">Scan suspicious links</span>
              </div>
              <div className="flex items-center gap-3 bg-green-50 dark:bg-green-900/30 rounded-lg p-4">
                <CheckCircle className="w-6 h-6 text-green-600 dark:text-green-400 flex-shrink-0" />
                <span className="text-gray-700 dark:text-gray-200 font-medium">Use strong passwords</span>
              </div>
              <div className="flex items-center gap-3 bg-green-50 dark:bg-green-900/30 rounded-lg p-4">
                <CheckCircle className="w-6 h-6 text-green-600 dark:text-green-400 flex-shrink-0" />
                <span className="text-gray-700 dark:text-gray-200 font-medium">Enable 2FA</span>
              </div>
              <div className="flex items-center gap-3 bg-green-50 dark:bg-green-900/30 rounded-lg p-4">
                <CheckCircle className="w-6 h-6 text-green-600 dark:text-green-400 flex-shrink-0" />
                <span className="text-gray-700 dark:text-gray-200 font-medium">Keep software updated</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-800 dark:text-white">Safe Link Practices</h2>
          </div>
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-800 dark:text-white">Password Security Tips</h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-gray-700 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-600">
              ...
              <h3 className="font-bold text-gray-800 dark:text-white mb-2">Use Long Passwords</h3>
            ...
            <div className="bg-white dark:bg-gray-700 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-600">
              <div className="text-4xl mb-4">🎲</div>
              <h3 className="font-bold text-gray-800 dark:text-white mb-2">Make Them Unique</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
            ...
            <div className="bg-white dark:bg-gray-700 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-600">
              ...
              <h3 className="font-bold text-gray-800 dark:text-white mb-2">Use a Password Manager</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
            ...
            <div className="bg-white dark:bg-gray-700 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-600">
              <div className="text-4xl mb-4">📱</div>
              <h3 className="font-bold text-gray-800 dark:text-white mb-2">Enable Two-Factor Auth</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
            ...
            <div className="bg-white dark:bg-gray-700 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-600">
              <div className="text-4xl mb-4">🚫</div>
              <h3 className="font-bold text-gray-800 dark:text-white mb-2">Avoid Personal Info</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
            ...
            <div className="bg-white dark:bg-gray-700 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-600">
              <div className="text-4xl mb-4">🔄</div>
              <h3 className="font-bold text-gray-800 dark:text-white mb-2">Change Compromised Passwords</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-800 dark:text-white">Email Safety Tips</h2>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              <div className="flex items-start gap-4 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                ...
                <div>
                  <h4 className="font-bold text-gray-800 dark:text-white">Check the Sender's Email Address</h4>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
              ...
              <div className="flex items-start gap-4 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                <AlertTriangle className="w-6 h-6 text-yellow-600 dark:text-yellow-400 flex-shrink-0 mt-1" />
                <div>
                  <h4 className="font-bold text-gray-800 dark:text-white">Beware of Urgent Language</h4>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
              ...
              <div className="flex items-start gap-4 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                <AlertTriangle className="w-6 h-6 text-yellow-600 dark:text-yellow-400 flex-shrink-0 mt-1" />
                <div>
                  <h4 className="font-bold text-gray-800 dark:text-white">Never Provide Sensitive Info</h4>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
              ...
              <div className="flex items-start gap-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                ...
                <div>
                  <h4 className="font-bold text-gray-800 dark:text-white">Scan Links Before Clicking</h4>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-800 dark:text-white">Safe Online Shopping</h2>
          </div>
          
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <h3 className="font-bold text-xl text-gray-800 dark:text-white">Before You Buy</h3>
              
              <div className="bg-white dark:bg-gray-700 rounded-lg p-4 border border-gray-200 dark:border-gray-600 flex items-start gap-3">
                <span className="bg-green-100 dark:bg-green-900/50 text-green-700 dark:text-green-300 font-bold rounded-full w-8 h-8 flex items-center justify-center text-sm flex-shrink-0">1</span>
                <div>
                  <h4 className="font-semibold text-gray-800 dark:text-white">Research the Store</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Look up reviews on Trustpilot, BBB, or Reddit. New stores with amazing deals are often scams.</p>
                </div>
              </div>
              
              <div className="bg-white dark:bg-gray-700 rounded-lg p-4 border border-gray-200 dark:border-gray-600 flex items-start gap-3">
                <span className="bg-green-100 dark:bg-green-900/50 text-green-700 dark:text-green-300 font-bold rounded-full w-8 h-8 flex items-center justify-center text-sm flex-shrink-0">2</span>
                <div>
                  <h4 className="font-semibold text-gray-800 dark:text-white">Verify HTTPS</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Never enter payment info on a site without the padlock icon in the address bar.</p>
                </div>
              </div>
              
              <div className="bg-white dark:bg-gray-700 rounded-lg p-4 border border-gray-200 dark:border-gray-600 flex items-start gap-3">
                <span className="bg-green-100 dark:bg-green-900/50 text-green-700 dark:text-green-300 font-bold rounded-full w-8 h-8 flex items-center justify-center text-sm flex-shrink-0">3</span>
                <div>
                  <h4 className="font-semibold text-gray-800 dark:text-white">Scan the URL</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Use LSafe to check if the shopping site has been reported for fraud or security issues.</p>
                </div>
              </div>
            </div>
            
            <div className="space-y-4">
              <h3 className="font-bold text-xl text-gray-800 dark:text-white">Payment Safety</h3>
              
              <div className="bg-white dark:bg-gray-700 rounded-lg p-4 border border-gray-200 dark:border-gray-600 flex items-start gap-3">
                <CreditCard className="w-6 h-6 text-blue-600 dark:text-blue-400 flex-shrink-0 mt-1" />
                <div>
                  <h4 className="font-semibold text-gray-800 dark:text-white">Use Credit Cards</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Credit cards offer better fraud protection than debit cards. You can dispute charges more easily.</p>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-gray-700 rounded-lg p-4 border border-gray-200 dark:border-gray-600 flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-800 dark:text-white">Use PayPal or Apple Pay</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">These services add a protection layer and don't share your actual card number with merchants.</p>
                </div>
              </div>
              
              <div className="bg-white dark:bg-gray-700 rounded-lg p-4 border border-gray-200 dark:border-gray-600 flex items-start gap-3">
                <Eye className="w-6 h-6 text-orange-600 dark:text-orange-400 flex-shrink-0 mt-1" />
                <div>
                  <h4 className="font-semibold text-gray-800 dark:text-white">Monitor Statements</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Check your bank statements regularly for unauthorized charges. Enable transaction alerts.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex items-center gap-4 mb-8">
            <div className="bg-pink-100 dark:bg-pink-900/30 rounded-full p-4">
              <Users className="w-8 h-8 text-pink-600 dark:text-pink-400" />
            </div>
            <h2 className="text-3xl font-bold text-gray-800 dark:text-white">Social Media Safety</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Mobile Device Safety</h2>
              </div>
              
              <div className="space-y-4">
                <div className="bg-white dark:bg-gray-700 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
                  <h4 className="font-semibold text-gray-800 dark:text-white mb-2">🔒 Lock Your Phone</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Use biometrics (fingerprint/face) plus a 6-digit PIN minimum. Avoid simple patterns.</p>
                </div>
                <div className="bg-white dark:bg-gray-700 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
                  <h4 className="font-semibold text-gray-800 dark:text-white mb-2">📱 Only Use Official App Stores</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Download apps only from Google Play or Apple App Store. Avoid APK files from websites.</p>
                </div>
                <div className="bg-white dark:bg-gray-700 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
                  <h4 className="font-semibold text-gray-800 dark:text-white mb-2">🔄 Keep Everything Updated</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Enable automatic updates for your OS and apps. Updates patch security vulnerabilities.</p>
                </div>
                <div className="bg-white dark:bg-gray-700 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
                  <h4 className="font-semibold text-gray-800 dark:text-white mb-2">📍 Review App Permissions</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Does a flashlight app need access to your contacts? Deny unnecessary permissions.</p>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center gap-4 mb-6">
                <div className="bg-cyan-100 dark:bg-cyan-900/30 rounded-full p-4">
                  <Wifi className="w-8 h-8 text-cyan-600 dark:text-cyan-400" />
                </div>
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Public WiFi Safety</h2>
              </div>
              
              <div className="space-y-4">
                <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                  <h4 className="font-semibold text-red-800 dark:text-red-300 mb-2">⚠️ Public WiFi Risks</h4>
                ...
                <div className="bg-white dark:bg-gray-700 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
                  <h4 className="font-semibold text-gray-800 dark:text-white mb-2">🛡️ Use a VPN</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">A VPN encrypts your connection, making it safe to use public WiFi. Many are free or low-cost.</p>
                </div>
                <div className="bg-white dark:bg-gray-700 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
                  <h4 className="font-semibold text-gray-800 dark:text-white mb-2">🚫 Avoid Sensitive Activities</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Don't do banking, shopping, or enter passwords on public WiFi without a VPN.</p>
                </div>
                <div className="bg-white dark:bg-gray-700 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
                  <h4 className="font-semibold text-gray-800 dark:text-white mb-2">📶 Disable Auto-Connect</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Turn off automatic WiFi connection. Only connect to networks you trust.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-800 dark:text-white">Safe Downloading Practices</h2>
          </div>
          
          <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-xl p-8">
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="font-bold text-lg text-gray-800 dark:text-white mb-4">✅ Safe Sources</h3>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3 text-gray-700 dark:text-gray-300">
              ...
              <div>
                <h3 className="font-bold text-lg text-gray-800 dark:text-white mb-4">❌ Dangerous Sources</h3>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3 text-gray-700 dark:text-gray-300">
            ...
            <div className="mt-8 bg-white dark:bg-gray-800 rounded-lg p-4 border border-yellow-300 dark:border-yellow-700">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-6">Want to Learn More?</h2>
